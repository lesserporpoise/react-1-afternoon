    ...
    render(){
            ...
            return (
              <div className="puzzleBox sumPB">
                <h4> Sum </h4>
                <input className="inputLine" type="text" onChange={ (e) => this.updateNum1(e.target.value) }></input>
                <input className="inputLine" type="text" onChange={ (e) => this.updateNum2(e.target.value) }></input>
